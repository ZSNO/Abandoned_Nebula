...
namespace textNS
{
    ...
    const int FONT_WIDTH  = 124;
    const int FONT_HEIGHT = 70;     // font is 62 pixels high
    ...
    const int ROWS = 6;            // number of rows in font image
    ...
    const int PROPORTIONAL_SPACING = 20; // pixels between 1:1 scaled characters
    const int TAB_SIZE = 8;
    const char UNDERLINE = '_';
    const char SOLID = 0x0020;        // solid block used for fill character ASCII $7F
