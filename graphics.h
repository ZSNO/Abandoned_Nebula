...
namespace graphicsNS
{
	...
	const COLOR_ARGB DKGRAY  = D3DCOLOR_ARGB(255, 92, 92, 92);
    const COLOR_ARGB BACK_COLOR = BLACK;                         // background color of game
    const COLOR_ARGB TRANSCOLOR = MAGENTA;                      // transparent color

	const COLOR_ARGB WASHGREEN = D3DCOLOR_ARGB(255,128,255,128);
	const COLOR_ARGB WASHPURPLE = D3DCOLOR_ARGB(255,255,128,255);
